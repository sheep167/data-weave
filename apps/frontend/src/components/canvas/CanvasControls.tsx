...
import { ZoomIn, ZoomOut, Maximize, Lock, Unlock, Grid3X3, Plus, Link2 } from "lucide-react";
...
export const CanvasControls = observer(() => {
    ...
    return (
        ...
        >
            ...
            <ToolbarButton
                icon={
                    ui.canvasLocked ? <Lock className="h-4 w-4" /> : <Unlock className="h-4 w-4" />
                }
                label={ui.canvasLocked ? t("canvas.lockCanvas") : t("canvas.unlockCanvas")}
